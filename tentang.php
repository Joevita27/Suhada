...
<div class="container">
  ...
  <hr> 
  <img src="assest/Tampak-Depan-Masjid-2.jpg" class="img-fluid mb-3" alt="Foto Masjid">
...
<p>Masjid Suhada hadir sebagai pusat ibadah dan kegiatan sosial keagamaan yang aktif, serta terus berperan dalam memperkuat ukhuwah dan nilai-nilai keislaman di lingkungan sekitarnya.</p>
  ...
  <hr>
  <ul>
    <li><strong>Ketua DKM:</strong> Joni Johari</li>
    <li><strong>Sekretaris:</strong> Fulan</li>
    <li><strong>Bendahara:</strong> Fulan</li>
    <li><strong>Koordinator Pengajian:</strong>Fulan</li>
    <li><strong>Koordinator Sosial:</strong> Fulan</li>
  </ul>
  ...
  <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="assest/Sign-Madrasah-Masjid.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="assest/Tampak-Depan-Masjid.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
